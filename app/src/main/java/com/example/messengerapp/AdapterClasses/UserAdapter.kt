...
import kotlinx.android.synthetic.main.user_seach_item_layout.view.*
...
class UserAdapter(
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(mContext).inflate(R.layout.user_seach_item_layout, viewGroup, false)
